...
public class GenericBigDecimalConverter implements GenericConverter {
	...
	public Set<ConvertiblePair> getConvertibleTypes() {
		...
		ConvertiblePair[] pairs = new ConvertiblePair[] { new ConvertiblePair(Number.class, BigDecimal.class),
				new ConvertiblePair(String.class, BigDecimal.class) };
		List<ConvertiblePair> asList = Arrays.asList(pairs);
		return asList.stream().collect(Collectors.toSet());
	}
